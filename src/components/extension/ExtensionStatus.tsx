  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Bodhi browser extension connection status
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {extension.extensionId && (
          <div className="flex items-center justify-between">
            ...
            <span className="font-mono text-sm text-gray-600">
              {extension.extensionId.substring(0, 8)}...
            </span>
          </div>
        )}
        ...
        <div className="flex justify-center gap-2">
          {(extension.status === "not-found" ||
            ...
            <Button
              onClick={extension.retry}
              disabled={extension.isDetecting}
              variant="outline"
              size="sm"
            >
          ...
          {extension.status === "ready" && extension.serverState && (
            <Button
              onClick={extension.refreshServerState}
              variant="outline"
              size="sm"
            >
              <RefreshCw className="mr-2 h-4 w-4" />
        ...
        {extension.status === "not-found" && (
          <div className="rounded-lg bg-blue-50 p-4">
            ...
            <p className="mb-3 text-sm text-blue-700">
              The Bodhi browser extension is not installed or not enabled.
              Please:
            </p>
