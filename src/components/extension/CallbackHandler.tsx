  ...
  useEffect(() => {
    ...
    const processCallback = async () => {
      try {
        ...
        console.log(
          "✅ [CallbackHandler] Token exchange completed successfully",
        );
        ...
        if (!mounted) return;
        console.error(
          "❌ [CallbackHandler] OAuth callback processing failed:",
          error,
        );
        setStepError();
        setState({
    ...
    if (hasCallbackParams && extension.client) {
      console.log(
        "🚀 [CallbackHandler] Starting callback processing (atomic, single execution)",
      );
      processCallback();
      ...
      <div className="mx-auto w-full max-w-4xl px-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">
            Completing authentication with BodhiApp
          </p>
        </div>
        ...
        <Card className="mx-auto w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              {isProcessing ? (state as any).step : "Processing OAuth callback"}
            </CardDescription>
          </CardHeader>
