import { AlertCircle, LogIn, LogOut, RefreshCw, User } from "lucide-react";
...
export function AuthCard() {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Waiting for Bodhi browser extension to be ready...
          </CardDescription>
        </CardHeader>
        <CardContent>
  ...
  const shouldShowLogin =
    !auth.isAuthenticated || (isServerLoggedOut && !isLoading);
